...
export class ClientController {
  ...
  @ApiOperation({ 
    ...
    description: 'Creates a new client with the provided information. Client names must be unique.'
  })
  @ApiResponse({ 
    status: 201, 
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieves a list of all clients. Supports filtering by name, country, and institute name.'
  })
  @ApiQuery({ name: 'name', required: false, description: 'Filter by client name', example: 'Acme' })
  ...
  @ApiOperation({ 
    ...
    description: 'Updates an existing client with the provided information. Client names must remain unique.'
  })
  @ApiParam({ name: 'id', description: 'Client ID', example: 1 })
  @ApiResponse({ 
    status: 200, 
