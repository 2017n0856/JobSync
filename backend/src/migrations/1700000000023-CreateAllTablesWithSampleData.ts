...
export class CreateAllTablesWithSampleData1700000000023
  implements MigrationInterface
{
  name = 'CreateAllTablesWithSampleData1700000000023';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      ('Maria Garcia', 'Spain', '+34-600-123-456', 'maria.garcia@pro.com', 'EUR', NULL, 'DESIGN,DEVELOPMENT,ANALYSIS', '{"experience_years": 4, "rating": 4.7}')
    `);
    ...
    await queryRunner.query(`
      ...
      ('Translation of Legal Documents', 'Translation of legal contracts from English to Spanish', '18:30:00', '2024-02-10', '2024-02-09', 300.00, 300.00, 200.00, 200.00, 3, 2, 'Translation', '{"word_count": 5000, "certified": true, "deadline_critical": true}'),
      ('Data Analysis Report', 'Statistical analysis and report generation for market research data', '16:00:00', '2024-02-25', NULL, 800.00, 0.00, 600.00, 0.00, 4, 3, 'Analysis', '{"dataset_size": "10MB", "analysis_type": "regression", "visualizations_required": true}')
    `);
  }
